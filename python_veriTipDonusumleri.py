#Pythonda veri tipleri dönüşümleri nasıl yapılır?
...
print(type(x)) # <class 'str'> print(type(y)) # <class 'str'>
...
x = float(x) # int to float print(x) # 10.0 print(type(x)) # <class 'float'>
# float veri türünden int veri türüne,

y = int(y) # float to int print(y) # 20 print(type(y)) # <class 'int'> 

# int veri türünden string veri türüne,

result = str(x) + str(y) # int to string print(result) # 1020.5 print(type(result)) # <class 'str'>

# bool veri türünden string veri türüne,

isOnline = str(isOnline) # bool to str print(isOnline) # True (string bir kelime) print(type(isOnline)) # <class 'str'>
